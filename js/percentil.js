    ...
    datasets: [
      {
          ...
          borderWidth: 2,
          data: [
              { x: 0, y: 17.3 }, { x: 0.16, y: 20.8 }, { x: 0.32, y: 22 },
              { x: 0.48, y: 22.3 }, { x: 0.64, y: 22.2 }, { x: 0.8, y: 21.9 },
              { x: 1, y: 21.6 }, { x: 1.16, y: 21.3 }, { x: 1.32, y: 21 },
              { x: 1.48, y: 20.8 }, { x: 1.64, y: 20.6 }, { x: 1.8, y: 20.5 },
              { x: 2, y: 20.4 },{ x: 2.0, y: 20.6 },{ x: 2.1, y: 20.6 },
              { x: 3, y: 20.3 }, 
              { x: 4, y: 20.6 }
          ],
      ...
      },
      {
          ...
          borderWidth: 2,
          data: [
              { x: 0, y: 16}, { x: 0.16, y: 19 }, { x: 0.32, y: 20.1 },
              { x: 0.48, y: 20.3 }, { x: 0.64, y: 20.2 }, { x: 0.8, y: 19.9 },
              { x: 1, y: 19.6 }, { x: 1.16, y: 19.3 }, { x: 1.32, y: 19.1 },
              { x: 1.48, y: 18.9 }, { x: 1.64, y: 18.7 }, { x: 1.8, y: 18.6 },
              { x: 2, y: 18.5 },{ x: 2.0, y: 18.8 },{ x: 2.1, y: 18.8 },
              { x: 3, y: 18.4 }, 
              { x: 4, y: 18.5 }
          ],
          showLine: true,
      ...
      },
      {
          ...
          borderWidth: 2,
          data: [
            { x: 0, y: 13.2}, { x: 0.16, y: 15.7 }, { x: 0.32, y: 16.7 },
            { x: 0.48, y: 16.9 }, { x: 0.64, y: 16.8 }, { x: 0.8, y: 16.6 },
            { x: 1, y: 16.4 }, { x: 1.16, y: 16.1 }, { x: 1.32, y: 15.9 },
            { x: 1.48, y: 15.7 }, { x: 1.64, y: 15.6 }, { x: 1.8, y: 15.5 },
            { x: 2, y: 15.4 },{ x: 2.0, y: 15.7 },{ x: 2.1, y: 15.7 },
            { x: 3, y: 15.4 }, 
            { x: 4, y: 15.3 }
          ],
          showLine: true,
      ...
      },
      {
          ...
          borderWidth: 2,
          data: [
            { x: 0, y: 10.7}, { x: 0.16, y: 13 }, { x: 0.32, y: 13.9 },
            { x: 0.48, y: 14.1 }, { x: 0.64, y: 14.1 }, { x: 0.8, y: 14 },
            { x: 1, y: 13.8 }, { x: 1.16, y: 13.6 }, { x: 1.32, y: 13.4 },
            { x: 1.48, y: 13.3 }, { x: 1.64, y: 13.2 }, { x: 1.8, y: 13.15 },
            { x: 2, y: 13.1},{ x: 2.0, y: 13.3 },{ x: 2.1, y: 13.3 },
            { x: 3, y: 13.1 }, 
            { x: 4, y: 12.8 }
          ],
          showLine: true,
      ...
      },
      {
          ...
          borderWidth: 2,
          data: [
            { x: 0, y: 9.6}, { x: 0.16, y: 11.8 }, { x: 0.32, y: 12.7 },
            { x: 0.48, y: 13 }, { x: 0.64, y: 13 }, { x: 0.8, y: 12.9 },
            { x: 1, y: 12.7 }, { x: 1.16, y: 12.6 }, { x: 1.32, y: 12.4 },
            { x: 1.48, y: 12.3 }, { x: 1.64, y: 12.25 }, { x: 1.8, y: 12.2 },
            { x: 2, y: 12.15 },{ x: 2.0, y: 12.4 },{ x: 2.1, y: 12.4 },
            { x: 3, y: 12.1 }, 
            { x: 4, y: 11.8 }
          ],
          showLine: true,
